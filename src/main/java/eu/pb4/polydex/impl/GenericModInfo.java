...
public class GenericModInfo {
    ...
    public static void build(ModContainer container) {
...

        {
            ...
            try {
                about.add(Component.literal(container.getMetadata().getName()).setStyle(Style.EMPTY.withColor(0x56ad56).withBold(true).withClickEvent(new ClickEvent.OpenUrl(URI.create(container.getMetadata().getContact().get("github").orElse("https://pb4.eu"))))));
                about.add(Component.translatable("text.polydex.about.version").setStyle(Style.EMPTY.withColor(0xf7e1a7))
                ...
                about.add(Component.literal("")
                        .append(Component.translatable("text.polydex.about.contributors")
